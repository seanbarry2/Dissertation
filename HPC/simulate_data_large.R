...
# simulate_data
simulate_data <- function(seed, species, sites) {
  ...
  # Modified environment and species sizes for two.two
  s.tree <- drop.tip(tree, (species + 1):50)
  cons.comp <- make.comp.comm(cons.occ[1:species], c(2, 5), env.sites[1:sites], s.tree)
